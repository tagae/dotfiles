...
-- of this list.
--
myWorkspaces = ["main", "mail", "web", "files", "code", "docs", "system" ] ++ map show [8..10]

-- Border colors for unfocused and focused windows, respectively.
--
myNormalBorderColor = "#808080"
myFocusedBorderColor = "#00B060"
...
myKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch dmenu
    , ((modm, xK_e), spawn "dmenu_run -fn 'Terminus-10:bold'")
...
--
main = do
  spawn "killall -TERM stalonetray; stalonetray"
